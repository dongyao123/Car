...
app.get("/admin/allcl",adm.allcl);

app.get("/admin/xinchelei",adm.xinchelei);

app.get("/admin/allcl2",adm.allcl2);



app.post("/admin/changekh",adm.changekh);
//添加车辆
app.get ("/admin/leixing",con.showleixing);
// app.post("/checklogin",con.checklogin);
// app.get ("/admin",adm.showAdmin);
app.post("/admin/addleixing",adm.addleixing);
app.post("/admin/deleteleixing",adm.deleteleixing);
app.get("/admin/allleixing",adm.allleixing);
app.post("/admin/changeleixing",adm.changeleixing);


// app.post("/admin/changekh",adm.addcar);
